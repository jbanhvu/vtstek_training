...
{
    public partial class FrmAttributeGenerateNormal : DevExpress.XtraEditors.XtraForm
    {
        ...
        private readonly DataTable dtTempS;
        #endregion

        #region "Contructor"

        public FrmAttributeGenerateNormal(DataTable dt)
        {
            InitializeComponent();
            _dt = dt;
        ...
        private void FrmGenerate_Load(object sender, EventArgs e)
        {
            ...
            gridControlLoadValue.DataSource = _dt;
        ...
        private void GridViewRmSelectedCustomInit(GridControl gridControl, GridView gridView)
        {
            ...
            GridColumn[] arrGridCol = new GridColumn[9];
            ...
            {
                Caption = @"AttibuteValueTemp",
                FieldName = "AttibuteValueTemp",
                Name = "AttibuteValueTemp",
                Visible = true,
                VisibleIndex = 6,
                Fixed = FixedStyle.None,
                //  ColumnEdit = repositoryText,
            ...
            {
                Caption = @"AttibuteUnit",
                FieldName = "AttibuteUnit",
                Name = "AttibuteUnit",
                Visible = true,
                VisibleIndex = 7,
                Fixed = FixedStyle.None,
            ...
            ProcessGeneral.HideVisibleColumnsGridView(gridView, false, "AttibutePK", "PK", "CNY00010PK", "AttibuteValueTemp", "AttibuteUnit", "IsNumber");
