...
{
    public class GridViewControlPagingFinal
    {
        #region "Property"
        ...
        public GridViewControlPagingFinal(GridControl gridControlData, GridView gvData, LabelControl labelDisplyPage, LabelControl labelCurrentRec, 
ComboBoxEdit droppageSize, SimpleButton btnFirst, SimpleButton btnPrevious, SimpleButton btnNext, SimpleButton btnLast,List<BestFitColumnPaging> lBfcol )
        {
        ...
        ///     </para>
        /// </param>
        public void Innitial(DataTable dt)
        {
            dtSource = dt;
            LoadComboPageSize(dt.Rows.Count);
            LoadDataPaging();
    ...
    public class BestFitColumnPaging
    {
        public String FiledName { get; set; }
        public Int32 IncreaseWidth { get; set; }
    }
}
