...
{
    public partial class XtraUC006MaterialReceipt : UserControl
    {
        #region "Property"
        readonly Inf_006MaterialReceipt inf = new Inf_006MaterialReceipt();
        ...
        #region "Contructor"
        public XtraUC006MaterialReceipt()
        {
            InitializeComponent();
        ...
        {
            _tp.Innitial(inf.sp_MaterialReceipt_Select(-1));
        ...
        {
            gcMain.DataSource = inf.sp_MaterialReceipt_Select(-1);
        ...
        {
            FormatGridView.CreateColumnOnGridview(gvMain, "Số phiếu ", "PK", -1);
            FormatGridView.CreateColumnOnGridview(gvMain, "Số yêu cầu", "MaterialRequirementPK", 1);
            FormatGridView.CreateColumnOnGridview(gvMain, "Người nhận", "Receiver", 2);
            ...
            FormatGridView.CreateColumnOnGridview(gvMain, "Người cấp vật tư", "Provider", 4);
            FormatGridView.CreateColumnOnGridview(gvMain, "Ngày cấp", "ReceivedDate", 4);
            ...
            //gvMain.Columns["UpdatedDate"].DisplayFormat.FormatType = DevExpress.Utils.FormatType.DateTime;
            //gvMain.Columns["UpdatedDate"].DisplayFormat.FormatString = "dd/mm/yyyy";
