...
{
    public partial class RptStockReceiveVT : DevExpress.XtraReports.UI.XtraReport
    {
        public RptStockReceiveVT(DataTable dtHeader, DataTable dtDetail, DataTable dtSignature)
        {
            InitializeComponent();
            //Header
