...
namespace CNY_WH.Info
{
    class Inf_002ReceiptNote
    {
        ...
        public DataTable sp_ApprovalHistory_SelectUserSignature(Int32 FunctionInApprovalPK, Int64 ItemPKInFunction)
        {
            ...
            return ac.TblReadDataSP("sp_ApprovalHistory_SelectUserSignature", arrPara);
        }
        public DataTable sp_GoodsReceivedNote_Select(Int64 PK)
        {
            var arrPara = new SqlParameter[1];
            arrPara[0] = new SqlParameter("@PK", SqlDbType.BigInt) { Value = PK };

            return ac.TblReadDataSP("sp_GoodsReceivedNote_Select", arrPara);
        }
        public DataTable sp_GoodsReceivedNoteDetail_Select(Int64 PK)
        {
            var arrPara = new SqlParameter[1];
            arrPara[0] = new SqlParameter("@GoodsReceivedNotePK", SqlDbType.BigInt) { Value = PK };

            return ac.TblReadDataSP("sp_GoodsReceivedNoteDetail_Select", arrPara);
        }
        public DataTable sp_GoodsDeliveryNote_Select(Int64 PK)
        {
            var arrPara = new SqlParameter[1];
            arrPara[0] = new SqlParameter("@PK", SqlDbType.BigInt) { Value = PK };

            return ac.TblReadDataSP("sp_GoodsDeliveryNote_Select", arrPara);
        }
        public DataTable sp_GoodsDeliveryNoteDetail_Select(Int64 PK)
        {
            var arrPara = new SqlParameter[1];
            arrPara[0] = new SqlParameter("@GoodsDeliveryNotePK", SqlDbType.BigInt) { Value = PK };

            return ac.TblReadDataSP("sp_GoodsDeliveryNoteDetail_Select", arrPara);
        }
        #endregion
