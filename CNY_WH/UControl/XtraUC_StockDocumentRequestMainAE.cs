...
namespace CNY_WH
{
    public partial class XtraUC_StockDocumentRequestMainAE : DevExpress.XtraEditors.XtraUserControl
    {
        ...
        private readonly Inf_StockDocumentRequest _inf = new Inf_StockDocumentRequest();
        ...
        private const string ErrorPrType = "SDR Type is not blank";
        ...
        public XtraUC_StockDocumentRequestMainAE(string paraoption,DataTable dtAdvanceFunc, Int64 HeaderPk)
        {
            InitializeComponent();
            ...
            ProcessGeneral.LoadSearchLookup(searchSDRType, _inf.LoadStockDocumentType(), "Code", "CNYMF026PK", BestFitMode.BestFitResizePopup, "CNYMF026PK", "SDRType");
            searchSDRType.EditValueChanged += searchSDRType_EditValueChanged;
            ...
            DataTable dtTempSource = Com_StockDocumentRequest.TableTreeviewTemplate();
            ...
            txtSDRNo.Properties.ReadOnly = true;
        ...
        private void TabItems_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            {
                if (searchSDRType.Text == "") // chưa chọn loại phiếu
                {
                    XtraMessageBox.Show("Please choose SDR Type", "Warning", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                    xtraCC.SelectedTabPage = TabGeneral;
                    searchSDRType.Focus();
                }
                else if (searchSDRType.Text == "2101") // lấy dữ liệu từ Work Order - không nhập tay
                {
                    XtraMessageBox.Show(string.Format("With SDR Type: '{0}' - Please choose 'Generate'", ProcessGeneral.GetSafeString(txtType.EditValue)), "Information", MessageBoxButtons.OK, MessageBoxIcon.Information);
                }
                else
                {
        ...
        #endregion
        #endregion
        private void searchSDRType_EditValueChanged(object sender, EventArgs e)
        {
            if (ProcessGeneral.GetSafeString(searchSDRType.EditValue) != "")
            {
                txtType.EditValue = ProcessGeneral.GetSafeString(ProcessGeneral.GetDataRowByEditValueKey(searchSDRType)["Description"]);
        ...
        private void EnableLookupType()
        {
            //if (_option == "EDIT")
            //{
            //    searchSDRType.Enabled = false;
            //    return;
            //}

            searchSDRType.Enabled = tlMain.AllNodesCount <= 0;
        }
        ...
        public void LoadDataWhenEdit(DataTable dtHeader, bool isBestFit)
        {
            ...
            searchSDRType.EditValue = ProcessGeneral.GetSafeInt(drHeader["SDRType"]);
            ...
            txtSDRNo.EditValue = ProcessGeneral.GetSafeString(drHeader["SDRNo"]);
        ...
        private void DefaultDataOnAdd()
        {
            ...
            txtSDRNo.EditValue = _sysCode.CodeRuleData.StrCode;
        ...
        public void RefreshDataWhenAddOrCopy(bool isBestFit)
        {
            ...
            LoadDataTreeView(tlMain, Com_StockDocumentRequest.TableTreeviewTemplate(), isBestFit);
        ...
        private void LoadDataTreeView(TreeList tl, DataTable dt, bool isBestFit)
        {
            ...
            if (searchSDRType.Text == "2101") // lấy dữ liệu từ Work Order
            {
                Com_StockDocumentRequest.VisibleTreeColumnSort(tl, true, arr);
            }
            else
            {
                Com_StockDocumentRequest.VisibleTreeColumnSort(tl, false, arr);
            }
        ...
        private void InitTreeList(TreeList treeList)
        {
            ...
            LoadDataTreeView(treeList, Com_StockDocumentRequest.TableTreeviewTemplate(), true);
        ...
        private void AddNewItemCode(TreeList tl, TreeListNode focuseNode, bool isAddChild)
        {
            ...
            _dlg = new WaitDialogForm();
            DataTable dtM = _inf.SDR_LoadNewItem(ProcessGeneral.GetSafeString(searchSDRType.Text), dtTDG00001PK,"");
            _dlg.Close();
            ...
            frm.OnWizardFinish += (s1, e1) =>
            {
                ...
                List<DataRow> lDr = e1.ReturnRowsSelected;
                DataTable dtAtemp = _inf.SDR_LoadAttribute_OnNewItem(lDr.AsEnumerable().Select(p => new
                {
        ...
        private void ShowListRmCodeF4OnTree(TreeListNode node, string fieldName)
        {
            ...
            _dlg = new WaitDialogForm();
            DataTable dtSource = _inf.SDR_LoadNewItem(ProcessGeneral.GetSafeString(searchSDRType.Text), dtTDG00001PK, "");
            _dlg.Close();
        ...
        private bool CheckDataBeforeSave()
        {
            ...
            if (_option.ToUpper().Trim() == "ADD")
            {
                ...
                if (!codeReturn.IsSusccess)
                {
                    XtraMessageBox.Show("SDR No. Is Not Created. \n Please Recheck Data.!!!", "Exclamation", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                }
                txtSDRNo.EditValue = _sysCode.CodeRuleData.StrCode;
            }
        ...
        public Ctrl_SDRSave SaveData()
        {
            if (!txtSDRNo.Focused)
            {
                txtSDRNo.SelectNextControl(ActiveControl, true, true, true, true);

            }
            Ctrl_SDRSave ctrl = new Ctrl_SDRSave();
            ...
            _inf.SDRType = ProcessGeneral.GetSafeInt64(searchSDRType.EditValue);
            _inf.SDRNo = ProcessGeneral.GetSafeString(txtSDRNo.EditValue);
            //_inf.SDRNo = String.Format("{0:yyyyMMdd}", dETD.DateTime);
            //_inf.SDRNo = String.Format("{0:yyyyMMdd}", dETA.DateTime);
        ...
        public bool GenerateData(string productionOrderNo)
        {
            ...
            if (searchSDRType.Text != "2101") // Không lấy dữ liệu từ Work Order - Chỉ nhập tay
            {
                XtraMessageBox.Show(string.Format("With SDR Type: '{0}' - Please choose key 'Insert'", ProcessGeneral.GetSafeString(txtType.EditValue)), "Information", MessageBoxButtons.OK, MessageBoxIcon.Information);
                return false;
            }
        ...
        private bool GenerateDataN(string productionOrderNo)
        {
            ...
            if (dtS == null)
            {
                dtSourceTree = Com_StockDocumentRequest.TableTreeviewTemplate();
            }
            else
            {
        ...
        private void BtnConvert_Click(object sender, EventArgs e)
        {
            ...
            _dlg = new WaitDialogForm();
            DataTable dtGf = Com_StockDocumentRequest.TablePackingFactorAttTemplate();
