...
namespace CNY_WH
{
    public partial class XtraUC_MROMain : XtraUserControl
    {


        #region "Property"
        readonly Inf_MaterialReleaseOrder _inf = new Inf_MaterialReleaseOrder();
        WaitDialogForm _dlg;
        ...
        #region "Contructor"
        public XtraUC_MROMain(params string[] arrPrType)
        {
            InitializeComponent();
            ...
            ProcessGeneral.SetTooltipControl(txtSearch, "Search By MRO No.", "Quick Search", ProcessGeneral.GetImageList(), 0, new Size(16, 16), DefaultBoolean.True, true, true);
            GridViewCustomInit();
            dt = GetData();
        ...
        private void LoadDataGridView()
        {
            ...
            ProcessGeneral.HideVisibleColumnsGridView(gvMain, false, "PK", "MROTypeCode");
            //bool visibleSo = !_arrPrType.Any(p => p == ConstSystem.DefaultPrSampleType || p == ConstSystem.DefaultPrSampleTypeF);
